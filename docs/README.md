...
<div class="provider-guides-table-wrap">
  <table class="provider-guides-table">
    ...
    <tbody>
      ...
      <tr><td>Hostinger</td><td>Antibot</td><td>2</td><td><span class="provider-chip">Headers</span><span class="provider-chip">HTML</span></td></tr>
      ...
      <tr><td>Instagram</td><td>Platform-specific</td><td>3</td><td><span class="provider-chip">HTML</span><span class="provider-chip">URL</span><span class="provider-chip">Status Code</span></td></tr>
